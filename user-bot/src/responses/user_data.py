...
class UserDataResponses:
    ...
    @staticmethod
    def get_confirm_patronymic_text(patronymic: str) -> str:
        return f"**Ваше отчество**: \n{escape_markdown_v2(patronymic)}"
    ...
    @staticmethod
    def get_confirm_grade_book_number_text(grade_book_number: str) -> str:
    ...
    @staticmethod
    def get_confirm_inn_text(inn: str) -> str:
        return f"**Ваш ИНН**: \n{escape_markdown_v2(inn)}"
    
    ASK_FOR_SNILS = "Пожалуйста, введите ваш номер  СНИЛС в том формате, в котором он указан в документе\."
    @staticmethod
    def get_confirm_snils_text(snils: str) -> str:
        return f"**Ваш СНИЛС**: \n{escape_markdown_v2(snils)}"
    ...
    ASK_FOR_WEIGHT = "Пожалуйста, выберите ваш вес\."
    @staticmethod
    def get_confirm_weight_text(weight: str) -> str:
        return f"**Ваш вес**: \n{escape_markdown_v2(weight)}"
    
    ASK_FOR_BONE_MARROW_TYPING_AGREEMENT = "Согласны ли вы на типирование костного мозга?"
    @staticmethod
    def get_confirm_bone_marrow_typing_agreement_text(bone_marrow_typing_agreement: str) -> str:
        return f"**Согласие на типирование костного мозга**: \n{escape_markdown_v2(bone_marrow_typing_agreement)}"
